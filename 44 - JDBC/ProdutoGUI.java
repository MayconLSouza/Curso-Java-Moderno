...
public class ProdutoGUI extends Application
{
	...
	{	
		...
		addButton.setOnAction(e -> {
			...
			var produto = new Produto(nomeInput.getText(), 
		...
		var updateButton = new Button("Atualizar");
		...
		var deleteButton = new Button("Excluir");
		deleteButton.setOnAction(e -> {
			Produto selectedProduto = tableView.getSelectionModel().getSelectedItem();
			if(selectedProduto != null)
			{
				produtoDAO.excluirPorId(selectedProduto.getId());
				produtos.setAll(produtoDAO.listarTodos());
				limparCampos();
			}
		});

		var clearButton = new Button("Limpar");
